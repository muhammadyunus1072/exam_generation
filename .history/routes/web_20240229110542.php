...
Route::group(["controller" => DashboardController::class, "prefix" => "coba", "as" => "dashboard."], function () {
...
Route::middleware('role:admin')->group(function () {
    ...
    Route::group(["controller" => RoleAndPermissionController::class, "prefix" => "roles_and_permissions", "as" => "roles_and_permissions."], function () {
        Route::get('/', 'index')->name('index');
    });
