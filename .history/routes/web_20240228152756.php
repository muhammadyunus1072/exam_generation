...
Route::middleware('role:admin')->group(function () {
    Route::group(["controller" => DashboardController::class, "prefix" => "users", "as" => "users."], function () {
        Route::get('/', 'index')->name('index');
    });
    Route::group(["controller" => DashboardController::class, "prefix" => "roles_and_permissions", "as" => "roles_and_permissions."], function () {
        Route::get('/', 'index')->name('index');
    });
});