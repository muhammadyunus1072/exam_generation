                ...
                <form wire:submit="save">
                    <div class="modal-body">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control form-control-solid" wire:model.blur="name" placeholder="Name"/>
                            @error('name') 
                        ...
                        <div class="mb-10">
                            ...
                            <input type="email" class="form-control form-control-solid" wire:model.blur="email" placeholder="Email"/>
                            @error('email') 
                                <span class="text-danger">{{$message}}</span> 
                            @enderror 
                        </div>
                        <div class="mb-10">
                            ...
                            <input type="password" class="form-control form-control-solid" wire:model.blur="password" placeholder="Email"/>
                            @error('password') 
                                <span class="text-danger">{{$message}}</span> 
                            @enderror 
                        </div>
                        ...
                        <div class="w-100 {{($is_verified)?'d-block':'d-none';}}">
                            <div class="mb-10" wire:ignore>
                                ...
                                <select class="form-select select2-role">
