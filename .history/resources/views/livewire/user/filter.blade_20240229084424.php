                ...
                <form wire:submit="save">
                    <div class="modal-body">
                        ...
                        <div class="mb-10" wire:ignore>
                            ...
                            <select class="form-select select2 select2-role" data-control="select2" data-placeholder="Select an option" >
                                <option></option>
    ...
    <script>
        $(() => {
            ...
            $('.select2-diagnosa').select2({
                ...
                ajax: {
                    url: "{{ route('laporan_clinical_pathway.get.clinical_pathway') }}",
                    dataType: "json",
                    type: "GET",
            ...
            $(".select2-diagnosa").on("select2:select", async (e) => {
                let data = e.params.data
                await @this.call('setFilterDiagnosa', data.id_icd10, data.kelas);
            })
        })
    </script>
@endpush
