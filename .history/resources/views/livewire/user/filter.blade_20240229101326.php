                ...
                <form wire:submit="save">
                    <div class="modal-body">
                        ...
                        <div class="mb-10">
                            ...
                            <input type="email" class="form-control form-control-solid" name="email" wire:model.blur="email" placeholder="Email"/>
                            @error('email') 
                                <span class="text-danger">{{$message}}</span> 
                            @enderror 
                        </div>
                        <div class="mb-10">
                            ...
                            <input type="password" class="form-control form-control-solid" name="password" wire:model.blur="password" placeholder="Email"/>
                            @error('password') 
                                <span class="text-danger">{{$message}}</span> 
                            @enderror 
                        </div>
                        ...
                        <div class="w-100">
                            <div class="mb-10" wire:ignore>
                                ...
                                <select class="form-select select2-role" wire:ignore.self>
...
@push('js')
    <script>
        ...
        function initSelect2(){
            ...
            $('.select2-role').on('change', async function(e) {
                let id = $('.select2-role').val();
                await @this.set('filter_ruangan', id);
            });
        ...
        Livewire.on('addSelect2Role', (data) => {
            $('.select2-role').val(data).trigger('change');
        });
