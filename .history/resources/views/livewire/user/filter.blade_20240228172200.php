        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-10">
                        <label for="exampleFormControlInput1" class="required form-label" aria-autocomplete="off">Name</label>
                    ...
                    <div class="mb-10">
                        ...
                        <input type="password" class="form-control form-control-solid" placeholder="Email"/>
                    </div>
                </div>
