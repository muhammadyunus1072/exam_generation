                ...
                <form wire:submit="saveRole">
                    <div class="modal-body">
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-control form-control-solid select2-jenis-no-register" multiple="multiple" name="jenis_no_register[]">
                            ...
                            <input type="text" class="form-control form-control-solid" name="permissions" wire:model.blur="permissions" placeholder="Role Name" required/>
                            @error('permissions') 
                                <span class="text-danger">{{$message}}</span> 
                            @enderror 
                        </div>
