    ...
    <script>
        ...
        Livewire.on('setSelectedPermissions', (data) => {
            ...
            data.forEach(permission => {
                console.log(permission.id); // Accessing the 'id' property of the permission
                console.log(permission.name); // Accessing the 'name' property of the permission
                console.log(permission.guard_name); // Accessing the 'guard_name' property of the permission
                console.log(permission.created_at); // Accessing the 'created_at' property of the permission
                console.log(permission.updated_at); // Accessing the 'updated_at' property of the permission
                console.log(permission.pivot);
            });
