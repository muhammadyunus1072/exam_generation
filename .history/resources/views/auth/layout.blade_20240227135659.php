	...
	<body id="kt_body" class="app-default" data-kt-app-page-loading-enabled="true" data-kt-app-page-loading="on">
		...
		<script>
			function alert_error(error, xhr){
				if (error == "show") {
					Swal.fire('Failed!', 'Terjadi kesalahan dalam memproses, harap menghubungi Administrator' + xhr.responseText, 'error');
				}

				if (error == "hide") {
					Swal.fire('Failed!', 'Terjadi kesalahan dalam memproses, harap menghubungi Administrator', 'error');
				}
			}
		</script>
        @stack('js')
