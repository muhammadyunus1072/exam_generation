	...
	<body id="kt_body" class="app-default" data-kt-app-page-loading-enabled="true" data-kt-app-page-loading="on">
		...
		<script>
			function alert_error(error, xhr){
				if (error == "show") {
					Swal.fire('Failed!', 'An error occurred while processing, please contact the Administrator' + xhr.responseText, 'error');
				}

				if (error == "hide") {
					Swal.fire('Failed!', 'An error occurred while processing, please contact the Administrator', 'error');
				}
			}
		</script>
        @stack('js')
