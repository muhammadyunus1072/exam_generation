							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										<!--begin::Menu item-->
										<div class="menu-item px-3 border border-success" style="overflow:scroll;">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<!--end::Avatar-->
												<!--begin::Username-->
												<div class="d-flex flex-column border border-danger">
													<div class="fw-bold d-flex align-items-center fs-5">
														{{Auth::user()->name}}
													</div>
													<a href="#" class="fw-semibold text-muted text-hover-primary fs-7" style="overflow: hidden;">{{Auth::user()->email}}</a>
												</div>
												<!--end::Username-->
											</div>
										</div>
