            ...
            [
                ...
                'render' => function ($item) {
                    ...
                    if ($authUser->hasPermissionTo("edit users")) {
                        ...
                        <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#editModal' wire:click=\"\$dispatch('editDetail','$item->id')\">
                    ...
                    $html = "<div class='row border d-flex justify-content-center'>
