...
class PermissionHelper
{
    ...
    // ---- LIST ACCESS ----
    // OPERASIONAL
    public const ACCESS_NON_FUNGSIONAL_TRANSAKSI = "non_fungsional_transaksi";
    public const ACCESS_NON_FUNGSIONAL_TRANSAKSI_STATUS = "non_fungsional_transaksi_status";
    public const ACCESS_NON_FUNGSIONAL_TRANSAKSI_PEMBAYARAN = "non_fungsional_transaksi_pembayaran";
    public const ACCESS_NON_FUNGSIONAL_KOREKSI = "non_fungsional_koreksi";
    public const ACCESS_LAMPIRAN_TINDAKAN = "lampiran_tindakan";
    public const ACCESS_LAYANAN_RUANGAN = "layanan_ruangan";

    // VERIFIKATOR
    public const ACCESS_VERIFIKASI_BILLING = "verifikasi_billing";
    public const ACCESS_VERIFIKASI_CODING = "verifikasi_coding";
    public const ACCESS_VERIFIKASI_FAILED = "verifikasi_failed";
    public const ACCESS_VERIFIKASI_PENGAJUAN = "verifikasi_pengajuan";

    // KASIR
    public const ACCESS_TAGIHAN_PASIEN = "tagihan_pasien";
    public const ACCESS_PEMBAYARAN_PASIEN = "pembayaran_pasien";

    // E-KLAIM
    public const ACCESS_CODING = "coding";
    public const ACCESS_REALISASI_LAYAK = "realisasi_layak";
    public const ACCESS_REALISASI_PENDING = "realisasi_pending";
    public const ACCESS_REALISASI_TIDAK_LAYAK = "realisasi_tidak_layak";
    public const ACCESS_REALISASI_DISPUTE = "realisasi_dispute";
    public const ACCESS_REALISASI_TRANSAKSI_PEMBAYARAN = "realisasi_transaksi_pembayaran";
    public const ACCESS_REALISASI_TRANSAKSI_KOREKSI = "realisasi_transaksi_koreksi";

    // PIUTANG
    public const ACCESS_COMPANY_RECEIVABLE = "company_receivable";
    public const ACCESS_INPUT_COMPANY_RECEIVABLE = "input_company_receivable";
    public const ACCESS_COMPANY_RECEIVABLE_PAYMENT = "company_receivable_payment";
    public const ACCESS_CORRECTION_COMPANY = "correction_company";
    public const ACCESS_PERSONAL_RECEIVABLE = "personal_receivable";
    public const ACCESS_PERSONAL_RECEIVABLE_PAYMENT = "personal_receivable_payment";
    public const ACCESS_CORRECTION_PERSONAL = "correction_personal";
    public const ACCESS_SURAT_TAGIHAN_COMPANY = "surat_tagihan_company";
    public const ACCESS_SURAT_TAGIHAN = "surat_tagihan";
    public const ACCESS_SURAT_PERNYATAAN_PIUTANG = "surat_pernyataan_piutang";

    // PIUTANG LANJUTAN
    public const ACCESS_SURAT_KPKNL = "surat_kpknl";
    public const ACCESS_SURAT_PSBDT = "surat_psbdt";
    public const ACCESS_SURAT_PPNTO = "surat_ppnto";

    // PIUTANG JKN
    public const ACCESS_PIUTANG_JKN_PEMBAYARAN = "piutang_jkn_pembayaran";
    public const ACCESS_PIUTANG_JKN_KOREKSI = "piutang_jkn_koreksi";
    
    // LAPORAN
    public const ACCESS_LAPORAN_REKAPITULASI_PIUTANG = "laporan_rekapitulasi_piutang";
    public const ACCESS_LAPORAN_TAGIHAN_BELUM_VERIFIKASI = "laporan_tagihan_belum_verifikasi";
    public const ACCESS_LAPORAN_REKAPITULASI_PIUTANG_PERUSAHAAN = "laporan_rekapitulasi_piutang_perusahaan";
    public const ACCESS_LAPORAN_REKAPITULASI_PIUTANG_PERORANGAN = "laporan_rekapitulasi_piutang_perorangan";
    public const ACCESS_REKAP_PEMBAYARAN_PIUTANG_PERORANGAN = "rekap_pembayaran_piutang_perorangan";
    public const ACCESS_REKAP_PIUTANG_PERORANGAN = "rekap_piutang_perorangan";
    public const ACCESS_REKAP_SURAT_TAGIHAN_PERUSAHAAN = "rekap_surat_tagihan_perusahaan";
    public const ACCESS_REKAP_PEMBAYARAN_PIUTANG_PERUSAHAAN = "rekap_pembayaran_piutang_perusahaan";
    public const ACCESS_REKAP_PIUTANG_PERUSAHAAN = "rekap_piutang_perusahaan";
    public const ACCESS_REKAP_PEMBAYARAN_PIUTANG_PERUSAHAAN_PERORANG = "rekap_pembayaran_piutang_perusahaan_perorang";
    public const ACCESS_REKAP_PIUTANG_PERUSAHAAN_PERORANG = "rekap_piutang_perusahaan_perorang";
    public const ACCESS_PERBANDINGAN_CODING = "perbandingan_coding";
    public const ACCESS_REKAP_NON_FUNGSIONAL_TRANSAKSI = 'rekap_non_fungsional_transaksi';
    public const ACCESS_REKAP_NON_FUNGSIONAL_PER_BULAN = 'rekap_non_fungsional_per_bulan';
    public const ACCESS_REKAP_NON_FUNGSIONAL_BULANAN = 'rekap_non_fungsional_bulanan';
    public const ACCESS_REKAP_REALISASI = "rekap_realisasi";
    public const ACCESS_LAPORAN_HASIL_TAGIHAN_PASIEN = "laporan_hasil_tagihan_pasien";
    public const ACCESS_LAPORAN_PETA_TARIF_TINDAKAN_OBAT = "laporan_peta_jenis_tindakan_obat";
    public const ACCESS_LAPORAN_PETA_TARIF_TINDAKAN_UNIT = "laporan_peta_jenis_tindakan_unit";
    public const ACCESS_LAPORAN_CLINICAL_PATHWAY = "laporan_clinical_pathway";
    public const ACCESS_LAPORAN_KPKNL = "laporan_kpknl";
    public const ACCESS_LAPORAN_PSBDT = "laporan_psbdt";
    public const ACCESS_LAPORAN_PPNTO = "laporan_ppnto";
    public const ACCESS_LAPORAN_MERGE_LAMPIRAN_TINDAKAN = "laporan_merge_lampiran_tindakan";

    // MASTER
    public const ACCESS_CLINICAL_PATHWAY = "clinical_pathway";
    public const ACCESS_USER = "user";
    public const ACCESS_PETUGAS_PIUTANG = "petugas_piutang";
    public const ACCESS_NON_FUNGSIONAL = "non_fungsional";
    public const ACCESS_TARIF_TINDAKAN_KONTRAKTOR = "tarif_tindakan_kontraktor";
    public const ACCESS_MASTER_TARIF_TINDAKAN = "master_tarif_tindakan";
    public const ACCESS_MASTER_JENIS_TINDAKAN = "master_jenis_tindakan";
    public const ACCESS_AKUN_KAS = "akun_kas";
    public const ACCESS_METODE_PEMBAYARAN = "metode_pembayaran";
    public const ACCESS_LAMPIRAN_SURAT_TAGIHAN = "lampiran_surat_tagihan";
    public const ACCESS_LAMPIRAN_SURAT_PERNYATAAN_PIUTANG = "lampiran_surat_pernyataan_piutang";
    public const ACCESS_PETA_TARIF_TINDAKAN = "peta_tarif_tindakan";
    public const ACCESS_PETA_TARIF_OBAT = "peta_tarif_obat";
    public const ACCESS_UNIT = "unit";
    public const ACCESS_PETA_TARIF_TINDAKAN_UNIT = "peta_jenis_tindakan_unit";
    public const ACCESS_PETA_TARIF_TINDAKAN_OBAT = "peta_jenis_tindakan_obat";
    public const ACCESS_PETA_JENIS_TINDAKAN_KE_JENIS_NO_REGISTER = "peta_jenis_tindakan_ke_jenis_no_register";

    // SIMRS
    public const ACCESS_SIMRS_RUANG = "simrs_ruang";
    public const ACCESS_SIMRS_OPERATOR = "simrs_operator";
    public const ACCESS_SIMRS_KONTRAKTOR = "simrs_kontraktor";
    public const ACCESS_SIMRS_JENIS_TINDAKAN = "simrs_jenis_tindakan";
    public const ACCESS_SIMRS_TARIF_TINDAKAN = "simrs_tarif_tindakan";
    public const ACCESS_SIMRS_MASTER_OBAT = "simrs_master_obat";
    public const ACCESS_SIMRS_DIAGNOSA = "simrs_diagnosa";
