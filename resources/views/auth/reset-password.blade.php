            ...
            <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                    ...
                    <form action="{{ route('password.update') }}" id="login-form" method="post" class="form w-100" novalidate="novalidate">
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Password-->
                            <input type="text" placeholder="Password" id="password" name="password" autocomplete="off" class="form-control bg-transparent" />
                            <!--end::Password-->
                        </div>
                        <!--end::Input group=-->
                        <!--begin::Input group=-->
                        <div class="fv-row mb-8">
                            ...
                            <input placeholder="Repeat Password" id="retype_password" name="retype_password" type="text" autocomplete="off" class="form-control bg-transparent" />
                            <!--end::Repeat Password-->
                        </div>
                        <div class="fv-row mb-8">
                            <div class="captcha">
