...
class Detail extends Component
{
    ...
    public function generate()
    {
        ...
        try {
            $prompt = sprintf(
                "Buatkan sebanyak %s soal ujian pilihan ganda bergaya resmi untuk jenjang %s kelas %s pada mata pelajaran %s, berdasarkan Kurikulum Merdeka yang berlaku di Indonesia.
